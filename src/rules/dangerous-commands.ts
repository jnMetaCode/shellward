...
export const DANGEROUS_COMMANDS: DangerousCommandRule[] = [
  {
    id: 'rm_rf_root',
    pattern: /rm\s+(-[a-zA-Z]*r[a-zA-Z]*\s+-[a-zA-Z]*f|-[a-zA-Z]*f[a-zA-Z]*\s+-[a-zA-Z]*r|-[a-zA-Z]*rf[a-zA-Z]*)\s+[\/~]/,
    description_zh: '递归强制删除根目录或用户目录',
    description_en: 'Recursive force delete on root or home directory',
  },
  {
    id: 'rm_rf_wildcard',
    pattern: /rm\s+(-[a-zA-Z]*rf|-[a-zA-Z]*fr)\s+\*/,
  ...
  {
    id: 'kill_all',
    pattern: /killall\s+-9|kill\s+-9\s+-1/,
